...
const PracticeLink = ({ odsCode, name }: { odsCode: string; name: string }) => {
  ...
  return (
    <Link to={`/practice/${odsCode}/transfers-requested`}>
...
export const PracticeTransfersRequestedTableWithSort: FC<TableWithSortProps> =
  ({ ccgPractices, headers, sortBySelect, orderSelect, tableCaption }) => {
