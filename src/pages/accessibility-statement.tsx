  ...
  return (
    <>
      ...
      <div className="nhsuk-u-reading-width">
        ...
        <p>
          The ability to search for a practice or a SICBL does not work without
          JavaScript, however an A-Z list of SICBLs is available to browse. The
          ...
          . Sorting functionality on the SICBL and practice pages will not work
          without JavaScript.
        </p>
        <p>
          When you click on a link and are navigated to a new page, the focus
          may remain on that link.
        </p>
        ...
        <p>
          ...
          enforcing the accessibility regulations. If you’re not happy with how
        ...
        <p>
          The Health and Social Care Information Centre is committed to making
          its website accessible, in accordance with the{" "}
        ...
        <p>
          We are mostly compliant with the WCAG 2.1 AA standard, however have
          one known issue. When you click on a link and are navigated to a new
          page, the focus may remain on that link.
        </p>
