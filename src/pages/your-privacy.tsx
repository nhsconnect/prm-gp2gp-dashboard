  ...
  return (
    <>
      ...
      <p>
        ...
        You can choose to share your email address if you want a reply.
        Otherwise, we collect and store feedback anonymously.
      </p>
      <h3>Cookies</h3>
      <p>
      ...
      <p>
        ...
        or to ask for feedback. These tools set their own cookies.
      </p>
      <h2>Keeping your personal data secure</h2>
      <p>
        We store your data on secure servers in England. A partner organisation
        is providing hosting services but has no say in how the information is
        used. There are no legal ways for their employees to see the data. Only
        approved people in the NHS GP Registrations Data team can see it.
      </p>
      <p>
      ...
      <p>
        ...
        commissioning groups (CCGs), and the National Clinical Governance Group.
      </p>
      <h3>Legal powers</h3>
      <p>
