...
describe("CCG Transfers Requested template - showContentsNavigation feature toggle is on", () => {
...
describe("CCG Transfers Requested template - showContentsNavigation feature toggle is off", () => {
  const pipelineCCGData = {
    odsCode: "12A",
    name: "BURTON CCG",
    ccgPractices: practiceMetricsMock,
