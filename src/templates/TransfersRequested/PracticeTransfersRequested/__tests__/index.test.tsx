...
describe("PracticeTransfersRequested template -  showContentsNavigation toggle is on", () => {
  beforeEach(() => {
    moxios.install();
...
describe("PracticeTransfersRequested template -  showContentsNavigation toggle is off", () => {
  beforeEach(() => {
    moxios.install();
    const statusCode = 200;
    const mockedResponse = practiceDataBuilder(ODSPracticeData);
