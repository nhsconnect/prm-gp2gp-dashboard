...
const stubbedDataUrl = `https://raw.githubusercontent.com/nhsconnect/prm-gp2gp-metrics-calculator/master/tests/e2e/test_metrics_calculator/expected_outputs/${config.metricsVersion}/${outputFileName}`;
