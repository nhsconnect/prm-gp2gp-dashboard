...
def test_returns_first_day_of_month_datetime():
    a_datetime = datetime(year=2021, month=2, day=15)

    actual = get_first_day_of_month_datetime(a_datetime)

    expected = datetime(year=2021, month=2, day=1, hour=0, minute=0, second=0, tzinfo=UTC)
